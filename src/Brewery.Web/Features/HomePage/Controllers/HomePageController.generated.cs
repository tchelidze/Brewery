...
namespace Brewery.Web.Features.HomePage.Controllers
{
    public partial class HomePageController
    {
        ...
        public HomePageController Actions => MVC.HomePage.HomePage;
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Area = "HomePage";
        [GeneratedCode("R4Mvc", "1.0")]
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_HomePageController : Brewery.Web.Features.HomePage.Controllers.HomePageController
    {
        public R4MVC_HomePageController(): base (Dummy.Instance)
        {
        }
