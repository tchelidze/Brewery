...
namespace Brewery.Web.Features.Bewery.Controllers
{
    public partial class BeerController
    {
        ...
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Area = "Bewery";
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Name = "Beer";
        [GeneratedCode("R4Mvc", "1.0")]
        public const string NameConst = "Beer";
        [GeneratedCode("R4Mvc", "1.0")]
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_BeerController : Brewery.Web.Features.Bewery.Controllers.BeerController
    {
        public R4MVC_BeerController(): base (Dummy.Instance)
        {
        }
